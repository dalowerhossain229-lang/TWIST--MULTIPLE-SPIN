...
const app = express(); // 🔒 [টাইপো ট্র্যাপ ওয়ান-শটে সাফ]: Math.abs কেটে দিয়ে সম্পূর্ণ বিশুদ্ধ এক্সপ্রেস নোড গেটওয়ে টাইট লক ওস্তাদ!
...
app.post('/api/twist-deal', async (req, res) => {
    ...
    try {
        ...
        while (isLoopActive && loopSafety < 150) {
            ...
            // পিওর ডাইনামিক স্বাধীন র্যান্ডম জেনারেশন ওস্তাদ!
